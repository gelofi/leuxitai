...
module.exports = {
    ...
    if(user.bot) return message.reply("bots can't get XP and aren't eligible for ranking.")
    ...
    let exp = await bot.dblevels.get(`xp_${message.guild.id}_${user.id}`);
