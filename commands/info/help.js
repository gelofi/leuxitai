  ...
  run: async (bot, message, args) => {
    ...
    if (args[0] === "support") {
      ...
      const owner = new Discord.RichEmbed()
        .setAuthor("Owner only Commands")
        .setDescription("The commands only the owner can control, even if someone tries to use them.")
        .addField("pluscribe | pls", "- subscribe a server to Leuxitai+");
      return message.channel.send(owner);
    } else if (args[0] === "rcbg") {
      const rcbg = new Discord.RichEmbed()
        .setAuthor("❓ Command: `rcbg`")
        .setDescription("change the background of your rank card in Leuxitai XP.\nRequires a **Leuxitai+** subscription for the server.")
        .addField("Aliases", "`custombg`  `rankcbg`");
      return message.channel.send(rcbg);
    } else if (args[0] === "rcc") {
      const rcbg = new Discord.RichEmbed()
        .setAuthor("❓ Command: `rcc`")
        .setDescription("change the color of your rank card in Leuxitai XP.\nRequires a **Leuxitai+** subscription for the server.")
        .addField("Aliases", "`color`  `colour`  `rankcc`");
      return message.channel.send(rcbg);
    ...
    } else if (args[0] === "ecoreset") {
      const ping = new Discord.RichEmbed()
        .setAuthor("❓ Command: `ecoreset`")
        .setDescription("reset your economy money count.")
        .addField("Aliases", "`reseteco`  `reseteconomy`");
      return message.channel.send(ping);
      ...
      var cmd = new Discord.RichEmbed()
        ...
        .addField("• Level Up messages (lvlmsg)", "Keep it clean, enable or disable alerts when someone levels up.")
      ...
      var cmd = new Discord.RichEmbed()
        ...
        .addField("shit", "ew, I stepped on shit!")
        .addField("changemymind", "make a change my mind meme, memelord!")
...
`)
      ...
      const rcbg = new Discord.RichEmbed()        .setAuthor("❓ Command: `cooldown`")
        .setDescription("change the cooldown of Leuxitai XP.")
        .addField("Aliases", "`cd`  `xpcooldown`");
      return message.channel.send(rcbg);
      ...
      return message.channel.send(cmd);
    } else if (args[0] === "connectfpur") {
      var cmd = new Discord.RichEmbed()
        .setAuthor("❓ Command: `connectfour`")
        .setDescription(`initiate a connect four game. 1 game per channel only.Requires Leuxitai+.\nUsage: \`${prefix}connectfour [@user]\``)
        .addField("Aliases", "`confour`  `c4`");
      return message.channel.send(cmd);
    } else if (args[0] === "plus") {
      const ping = new Discord.RichEmbed()
        .setAuthor("❓ Command: `plus`")
        .setDescription("discover Leuxitai+ subscription features.")
      ...
      const help = new Discord.RichEmbed()
        ...
        .addField(
          `${info}  Information`,
          "`help`, `support`, `ping`, `invite`, `weather`, `changelogs`, `manual`, `stats`, `settings`, `plus`"
        )
        .addField(
          `${orbs}  Fun and Random`,
          "`coinflip`, `say`, `8ball`, `topic`, `wisdom`, `percent`, `cumberbatch`, `autocomplete`, `hangman`, `uwu`, `connectfour`"
        )
        .addField(
          `:frame_photo:  Images`,
        ...
        .addField(
          `${levels}  Levels`,
          "`points`, `leaderboard`, `addxp`, `addlevel`, `xpreset`, `levelroles`, `rcbg`, `rcc`, `cooldown`"
        )
        .addField(
          `${coins}  Economy`,
          "`work`, `beg`, `daily`, `balance`, `rob`, `roulette`, `weekly`, `deposit`, `withdraw`, `addmoney`, `removemoney`, `buy`, `shop`, `crime`, `inventory`, `chickenfight`, `slots`, `transfer`, `reseteco`"
        )
        .addField(
          `${mod}  Moderation`,
