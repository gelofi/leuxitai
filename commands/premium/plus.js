...
module.exports = {
    ...
    run: async (bot, message, args) => {
      ...
      message.channel.send("**Plus** is no longer needed.\n\nYou may enjoy features such as RCBG, and playing Connect Four.\nYou may donate to us! Use the `support` command, and donate if you want to!")
